		...
		if (Global.GameStart == true) {
			...
			if (transform.position.y < 8.5) {
				if (fait == false) {
					...
					if (Global.Score >= 0 && Global.Score < 40) {
					...
					// part 4 four line with 3 type 
						...
						if (randomplace == 1) {
							randomtile = Random.Range (1, 4);
							if (randomtile == 1)
								Instantiate (newtile, new Vector2 (-3.1f, 12f), transform.rotation);
							if (randomtile == 2)
								Instantiate (newtile2, new Vector2 (-3.1f, 12f), transform.rotation);
							if (randomtile == 3)
								Instantiate (newtile3, new Vector2 (-3.1f, 12f), transform.rotation);
						} else if (randomplace == 2) {
							randomtile = Random.Range (1, 4);
							if (randomtile == 1)
